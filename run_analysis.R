...
#Set directory
setwd("C:\\Users\\lenovo\\Documents\\Data Science Coursera\\Curso 3")
...
write.table(SecondDataSet, file = "C:\\Users\\lenovo\\Documents\\Data Science Coursera\\Curso 3\\course_project_Getting_and_Cleaning_data\\tidydata.txt",row.name=FALSE)
