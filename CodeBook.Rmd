...
This document is a required code book within the final project of the course obtaining and cleaning data with R of the Data Science Program, in order to describe the transformations worked with the data.
